/*
  import all the images and use them everywhere
*/
export default {
  logo: require("../assets/images/logo.png"),
  intro_one: require("../assets/images/intro_one.png"),
  intro_two: require("../assets/images/intro_two.png"),
  intro_three: require("../assets/images/intro_three.png"),
